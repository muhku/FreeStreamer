...
public:
    ...
    void streamMetaDataAvailable(std::map<std::wstring,std::wstring> metaData);
...
public:
    ...
    virtual void audioStreamMetaDataAvailable(std::map<std::wstring,std::wstring> metaData) = 0;
};    
